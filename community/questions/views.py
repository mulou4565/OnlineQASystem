...
# 涉及表单类的视图类需要提供一个 form_valid 方法用于处理表单验证完毕后的工作

# login_required是个函数，千万不要加引号！！！
...
# 展示问题涉及分页功能，我们使用 Django 框架提供的 ListView 作为视图基类。
...
class QuestionDetailView(CreateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        #! get_context_data 在父类中也有定义
        #! 其作用是给模板文件提供 context 属性值
        #! 里面的键值对可以在前端模板中使用
